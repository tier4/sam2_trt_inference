...
void process_image(std::string &encoder_path,
                   ...
                   const int decoder_batch_limit)
{
    ...
    sam2 = std::make_unique<SAM2Image>(encoder_path, decoder_path, encoder_input_size, precision, decoder_batch_limit);
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        process_image(encoder_path, decoder_path, img_path, bbox_file_path, output_jpg_path, precision, batch_size, decoder_batch_limit);
